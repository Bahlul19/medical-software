...
if($uInfo['role'] == 1 || $uInfo['role'] == 2){
	...
	echo "<button onclick = 'exportCSV();' id = 'export'> Export This Result To CSV (MS Excel) </button>";
...
// here we swap stuff using ajax.
echo "<div id='table-scroll' class='table-scroll'>";
echo "<div class = 'table-responsive table-wrap' id='appointmentTable'>";
