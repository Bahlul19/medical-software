...
formForm('proc/editInterpreter.php','post');
...
br();
br();
formForm('proc/deleteInterpreter.php','post','onsubmit = "return confirmDelete();"');
formInput('delID','hidden',$thisUser);
echo "<input type = 'submit' value = 'Delete This Interpreter' class = 'delete' >";
formClose();
clearfix();
